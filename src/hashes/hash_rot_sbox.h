#ifndef _HASH_ROT_SBOX_H_
#define _HASH_ROT_SBOX_H_

#include "hash_common.h"
#include "hash_buf.h"

template<int LEN> class hash_rot_sbox {
private:
...
template <int LEN> const uint32_t hash_rot_sbox<LEN>::sbox[] = {
